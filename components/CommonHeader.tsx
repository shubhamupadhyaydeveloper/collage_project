    ...
    return (
        ...
        <View style={{ paddingTop: insets.top + 20, marginBottom: verticalScale(10), justifyContent: 'center' }}>
            ...
            {/* <View style={{ marginTop: verticalScale(20) }}>
                <Text style={{ fontSize: 18,  lineHeight: 20, color: 'white', opacity: .8 }}>An AI-powered quiz generator app that helps you prepare for exams by creating quizzes from text, images, or scanned documents.</Text>
            </View>

            <View style={{ marginTop: verticalScale(20) }}>
                <Text style={{ fontSize: 18, fontWeight : 'bold', lineHeight: 20, color: 'white', opacity: 1 }}>Things you can do here</Text>
            </View> */}
        </View>
    )
